...
description: >
  ...
  finances, budgeting, spending, debt, investing, savings, retirement, or wealth building.
  Also trigger when the user mentions their paycheck, bills, subscriptions, bonuses, 401k,
  Roth IRA, brokerage accounts, or any financial decision. Even if the user doesn't use
  financial words explicitly — phrases like "should I buy this", "can I afford",
  "is this worth it", or "what should I do with my money" should all trigger this skill.
...
1. High-interest debt first (credit cards)
2. 401k loans (double taxation — money taxed going in AND coming out)
3. Other installment debt
4. Low-interest debt (mortgage) — least urgent

### The Investment Ladder (priority order)
1. 401k up to employer match (free money — always do this first)
2. Pay off high-interest debt
3. Max Roth IRA ($7,000/year limit in 2024-2025)
4. Max 401k ($23,500/year limit in 2025)
5. Taxable brokerage account (VOO or similar index funds)
...
3. Pay taxes only on any gains (usually minimal if done quickly)
...
1. Eliminate any 401k loans (double taxation)
2. Pay off high-interest debt
3. Top up emergency fund to 3-6 months
4. Max Roth IRA ($7,000)
5. Invest remainder in brokerage (VOO)
